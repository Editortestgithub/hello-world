...
{ 
    ...
    { 
        ...
        [HttpPost]
        [Route("/Editororgone/1213/1.0.0/user")]
        [ValidateModelState]
        ...
        /// <response code="0">successful operation</response>
        [HttpPost]
        [Route("/Editororgone/1213/1.0.0/user/createWithArray")]
        [ValidateModelState]
        ...
        /// <response code="0">successful operation</response>
        [HttpPost]
        [Route("/Editororgone/1213/1.0.0/user/createWithList")]
        [ValidateModelState]
        ...
        [HttpDelete]
        [Route("/Editororgone/1213/1.0.0/user/{username}")]
        [ValidateModelState]
        ...
        [HttpGet]
        [Route("/Editororgone/1213/1.0.0/user/login")]
        [ValidateModelState]
        ...
        /// <response code="0">successful operation</response>
        [HttpGet]
        [Route("/Editororgone/1213/1.0.0/user/logout")]
        [ValidateModelState]
